 ...
 * lives in the HakiChain AI web app, which is a far richer surface than a 300px pane;
    ...
    playbooks.length === 0 ? (
      <div className="stack playbook-empty">
        ...
        <span className="small muted">
          Create and edit playbooks in the HakiChain AI web app, then run them here against your document.
        </span>
        <div className="row playbook-empty__cta">
          <a className="btn btn--primary btn--sm" href={manageHref} target="_blank" rel="noreferrer">
            <PlaybookIcon size={14} /> Create a playbook in HakiChain AI
          </a>
        </div>
      </div>
    ) : (
