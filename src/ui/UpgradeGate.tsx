...
/** Where the "Get HakiChain AI hosted" upsell points. One place to change it. */
export const HOSTED_URL = "https://app.hakichain.com/auth/signup";
...
/**
 * Community-edition upsell card. Shown where a feature needs HakiChain AI's hosted
