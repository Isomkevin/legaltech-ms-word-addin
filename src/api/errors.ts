/**
 * Typed API errors mapped from the HakiChain AI backend error contract.
...
export function friendlyMessage(err: ApiError): string {
  switch (err.kind) {
    case "quota":
      return "You have reached your usage limit for this plan. Open HakiChain AI to upgrade or wait for your quota to reset.";
    case "too_large":
    ...
    case "network":
      return "Cannot reach HakiChain. Check your connection and try again.";
    case "server":
      return "HakiChain AI had a problem completing that. Please try again.";
    default:
