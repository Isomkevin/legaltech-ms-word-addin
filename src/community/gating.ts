 ...
 * HakiChain AI's hosted data or account throws REQUIRES_ACCOUNT. These helpers let the
 ...
 */
export const REQUIRES_ACCOUNT_NOTE = "Requires a HakiChain AI account";

/** Surfaces that only make sense with a hosted HakiChain AI account. */
 ...
 * CourtListener). Statute resolution still needs HakiChain AI's corpus and stays off.
 */
